...
class WoDeShouCangViewController: ShowNavibarViewController {
    ...
    @objc func refreshData() {
       ...
       post("user/collectionList", parameters: parameters, true, false) {(result) in
     ...
     func initTable(_ table: UITableView) {
        ...
        let adapter = BaseCellViewAdapter(tableView: table, cellClass: TableViewCell_2.self, datas: self.zjsonModel["data"] , xib:true)
