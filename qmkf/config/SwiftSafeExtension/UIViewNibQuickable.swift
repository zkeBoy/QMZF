...
extension UIView {
    ...
    @objc public class func loadNib(nibName :  String ,
    ...
    public class func loadView(nibName: String) -> UIView {
        (UINib.init(nibName: nibName, bundle: nil).instantiate(withOwner: nil, options: nil)[0] as? UIView)!
    }
